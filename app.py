...
@st.cache_data
def load_data():
    df = pd.read_csv('dataaa_pkpu - Sheet1.csv')
...
# ==================== 4. HEADER & KPI ====================
st.title("⚖️ Dashboard Analisis Kasus PKPU")
...
tab1, tab2, tab3, tab4, tab5 = st.tabs([
    "🎯 Analisis Sektor", "🗺️ Peta Wilayah", "💸 Nilai Utang", 
...
# ==================== TAB 2: PETA WILAYAH ====================
with tab2:
    st.subheader("🗺️ Distribusi Geografis Kasus PKPU")
    ...
    with col_d:
        ...
        fig_area = px.bar(
            area_analysis,
            x='Area', y='Jumlah_Kasus',
            title='<b>Distribusi Kasus per Area</b>',
            color='Jumlah_Kasus',
